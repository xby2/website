...
function nanosoft_register_assets() {
	...
	// Theme's scripts
	wp_register_script( 'tween-lite', get_template_directory_uri() . '/assets/js/vendor/tween-lite.js', [], NANOSOFT_VERSION, true );
	wp_register_script( 'ease-pack', get_template_directory_uri() . '/assets/js/vendor/ease-pack.js', [], NANOSOFT_VERSION, true );

	wp_register_script( 'isotope', get_template_directory_uri() . '/assets/js/vendor/isotope.js', array( 'jquery' ), NANOSOFT_VERSION, true );
	wp_register_script( 'isotope-packery', get_template_directory_uri() . '/assets/js/vendor/isotope-packery.js', array( 'isotope' ), NANOSOFT_VERSION, true );
	wp_register_script( 'packery', get_template_directory_uri() . '/assets/js/vendor/packery.js', array( 'jquery' ), NANOSOFT_VERSION, true );
	wp_register_script( 'waypoints', get_template_directory_uri() . '/assets/js/vendor/waypoints.js', array( 'jquery' ), NANOSOFT_VERSION, true );
	wp_register_script( 'waypoints-inview', get_template_directory_uri() . '/assets/js/vendor/waypoints-inview.js', array( 'jquery' ), NANOSOFT_VERSION, true );
	wp_register_script( 'swiper', get_template_directory_uri() . '/assets/js/vendor/swiper.js', array( 'jquery' ), NANOSOFT_VERSION, true );
	wp_register_script( 'pretty-photo', get_template_directory_uri() . '/assets/js/vendor/pretty-photo.js', array( 'jquery' ), NANOSOFT_VERSION, true );
	wp_register_script( 'count-to', get_template_directory_uri() . '/assets/js/vendor/count-to.js', array( 'jquery' ), NANOSOFT_VERSION, true );
	wp_register_script( 'match-height', get_template_directory_uri() . '/assets/js/vendor/match-height.js', array( 'jquery' ), NANOSOFT_VERSION, true );

	wp_register_script( 'nanosoft', get_template_directory_uri() . '/assets/js/theme.js', [
		'imagesloaded',
		'isotope',
		'isotope-packery',
		'packery',
